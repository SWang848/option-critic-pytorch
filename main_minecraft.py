...
parser.add_argument('--env', default='MineCratingEnv', help='ROM to run')
...
parser.add_argument('--num-options', type=int, default=10, help=('Number of options to create.'))
...
def run(args):
    ...
    logger = Logger(logdir=args.logdir, run_name=f"OptionCritic-{args.env}-{args.exp}-{time.ctime()}")
